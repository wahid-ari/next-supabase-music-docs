...
export default function Expandable({ title, description, defaultOpen = false, children }) {
  ...
  return (
    <div key={title} role="listitem" className="">
      <button
        ...
        className={cn("not-prose mt-2 flex flex-row items-center content-center w-full py-1 text-neutral-700",
