...
## 11/30/22 Release Notes
- Dashboard UX revamp
- Additional Jira and GitHub tables for new connections

## 11/14/22 Release Notes
- Extended Jira and GitHub connectors to obtain more data
- Added support for advanced rendering parameters on the editor

## 10/17/22 Release Notes
- Ability to create and share dashboards
- Ability for customers to bring their own Azure infrastructure
- Support for ingesting more GitHub data with new GitHub App

## 10/06/22 Release Notes
- Support for Intuned Admin, Editor, and Viewer roles
- Ability to build and edit parameters into dashboards
- Ability to review Jira history
- Ability to rename Workspace

## 9/26/22 Release Notes
- Google Sheets Integration will allow you augement your exisiting data with mappings you track in spreadsheets. 
